        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-6 mt-2">
                    <a href="/create-meal" class="btn btn-primary">Create</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody id="userTableBody">
                            ...
                            <tr>
                                ...
                                <td>{{ $model->name }}</td>
                                <td>
                                    <!-- Button to show the count of ingredients -->
                                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#ingredientsModal{{ $model->id }}">
                                        {{ $model->ingridents->count() }}
                                    </button>
                                    <!-- Modal for displaying ingredients -->
                                    <div class="modal fade" id="ingredientsModal{{ $model->id }}" tabindex="-1" role="dialog" aria-labelledby="ingredientsModalLabel{{ $model->id }}" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="ingredientsModalLabel{{ $model->id }}">{{ $model->name }} Ingredients</h5>
                                                ...
                                                <div class="modal-body">
                                                    <ul>
                                                        @foreach ($model->ingridents as $ingredient)
                                    ...
                                    <div class="modal fade" id="edit{{ $model->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('meal.update', $model->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
