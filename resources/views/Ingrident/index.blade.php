                        ...
                        <table class="table table-striped">
                            ...
                            <tbody id="userTableBody">
                                @foreach ($models as $model)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                                data-bs-target="#mealsModal{{ $model->id }}">
                                                {{ $model->meals()->count() }}
                                            </button>
                                        </td>
                                        <td>
                                    ...
                                    <!-- Modal to show meals using this ingredient -->
                                    <div class="modal fade" id="mealsModal{{ $model->id }}" tabindex="-1" aria-labelledby="mealsModalLabel{{ $model->id }}" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="mealsModalLabel{{ $model->id }}">Meals using {{ $model->name }}</h5>
